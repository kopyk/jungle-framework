---
id: jungle-decision-framework
sidebar_position: 1
title: Jungle Decision Framework
description: A scalable macro system for junglers, from Iron to Challenger. Season 15 (Patch 15.24+).
---
...
| Rank Range | What You Gain |
|-----------|---------------|
| **Iron–Bronze** | Clear checklists: full clear → gank pushed lanes → reduce chaos. |
| **Silver–Gold** | Pathing + tracking: predict the enemy jungler and punish mistakes. |
| **Platinum–Diamond** | Tempo control: trade objectives and pressure cross-map. |
...
### Core Framework
- **[Foundations](./foundations.md)** — Jungle camps, clears, and core definitions  
- **[Decision Rules](./decision-rules.md)** — If–then heuristics for ganks, invades, and objectives  
- **[Decision Tree](./decision-tree.md)** — Visual logic for in-game decision paths  

### Practice
- **[Examples](./examples.md)** — Real pathing scenarios and applications  
- **[Common Mistakes](./common-mistakes.md)** — Frequent errors and how to fix them  

### Reference
- **[Glossary](./glossary.md)** — Terminology used throughout the framework  
